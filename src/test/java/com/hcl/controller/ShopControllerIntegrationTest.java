...
public class ShopControllerIntegrationTest {
	...
	private void mockShops() {
		this.shop1 = new Shop("Shop 1", new ShopAddress("LA-1111", "70526", "Crowley, LA"));
		this.shop2 = new Shop("Shop 2", new ShopAddress("State Hwy 1111", "41339", "Jackson, KY"));
		this.shop3 = new Shop("Shop 3", new ShopAddress("LA-1111 Spur", "70526", "Crowley, LA"));
		this.shop4 = new Shop("Shop 4", new ShopAddress("State Rte 1111", "23238", "Henrico, VA"));
	...
	private void mockShop() {
		ShopAddress shopAddress = new ShopAddress("1", "411038",
				"Mother's Kitchen, Vishal Nagar, Pimpri-Chinchwad, Maharashtra");
	...
	public void addShop() throws JsonProcessingException, Exception {
		...
		shop.setShopAddress(new ShopAddress("22", "411029",
				"CopaCabana,Omkar Society, Pimple Nilakh, Pimpri-Chinchwad, Maharashtra"));
		this.mockMvc
				.perform(post(SHOP_REST_CONTROLLER).contentType(MediaType.APPLICATION_JSON)
						.content(objectMapper.writeValueAsBytes(this.shop)).accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk())
				.andExpect(jsonPath("$.currentAddress.shopAddress.postCode", equalTo("411029")));
	}
